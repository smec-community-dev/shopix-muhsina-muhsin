...
SECRET_KEY = 'django-insecure-4q)3u)$#d3+%b*_q^^b4abph6m^6k971-991$)r&i=xaeb+fcy'
...
TEMPLATES = [
    {
        ...
        # use absolute path for templates directory so loader always finds files
